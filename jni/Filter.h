...
JNIEXPORT void JNICALL Java_ru_flightlabs_makeup_Filter_nativeDrawMask(JNIEnv * jenv, jclass, jlong imageFrom, jlong imageTo, jobjectArray pointsWas1, jobjectArray pointsTo1, jobjectArray triangle1, jlong imageLips, jobjectArray pointsWasLips, jobjectArray trianglelips);
